"""sca_sybil_based_collusion_attacks URL Configuration
...
from sca_sybil_based_collusion_attacks import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Attack_Status/$', remoteuser.Predict_Attack_Status, name="Predict_Attack_Status"),
    ...
    url(r'^View_All_Sybil_based_Collusion_Attack_Status_Ratio/$', serviceprovider.View_All_Sybil_based_Collusion_Attack_Status_Ratio, name="View_All_Sybil_based_Collusion_Attack_Status_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_All_Sybil_based_Collusion_Attack_Status/$', serviceprovider.View_All_Sybil_based_Collusion_Attack_Status, name="View_All_Sybil_based_Collusion_Attack_Status"),

...
urlpatterns = [
    ...
    re_path(r'^View_All_Sybil_based_Collusion_Attack_Status_Ratio/$', serviceprovider.View_All_Sybil_based_Collusion_Attack_Status_Ratio, name="View_All_Sybil_based_Collusion_Attack_Status_Ratio"),
    re_path(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    re_path(r'^View_All_Sybil_based_Collusion_Attack_Status/$', serviceprovider.View_All_Sybil_based_Collusion_Attack_Status, name="View_All_Sybil_based_Collusion_Attack_Status"),

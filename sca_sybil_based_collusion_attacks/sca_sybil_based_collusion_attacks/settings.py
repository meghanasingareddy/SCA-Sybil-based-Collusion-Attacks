...
ROOT_URLCONF = 'sca_sybil_based_collusion_attacks.urls'
...
WSGI_APPLICATION = 'sca_sybil_based_collusion_attacks.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'sca_sybil_based_collusion_attacks',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',

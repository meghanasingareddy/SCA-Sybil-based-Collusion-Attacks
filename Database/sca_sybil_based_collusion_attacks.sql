...
--
-- Host: localhost
-- Generation Time: Sep 29, 2022 at 12:41 PM
...
--
-- Database: `sca_sybil_based_collusion_attacks`
--
CREATE DATABASE IF NOT EXISTS `sca_sybil_based_collusion_attacks` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `sca_sybil_based_collusion_attacks`;
...
(5, 'Naive Bayes', '50.410837219631354'),
(6, 'SVM', '49.43371085942705'),
(7, 'Logistic Regression', '50.410837219631354'),
(8, 'Decision Tree Classifier', '51.52120808349989'),
(9, 'SGD Classifier', '51.47679324894515');
...
(9, 'Attack Found', '33.33333333333333'),
(10, 'No Attack Found', '66.66666666666666');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_detect_sybil_based_collusion_attacks`
--

CREATE TABLE IF NOT EXISTS `remote_user_detect_sybil_based_collusion_attacks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `source_ip` varchar(300) NOT NULL,
  `destination_ip` varchar(300) NOT NULL,
  `start_time` varchar(300) NOT NULL,
  `Network_Node_Text` varchar(30000) NOT NULL,
  `source_port` varchar(300) NOT NULL,
  `destination_port` varchar(300) NOT NULL,
  `flags` varchar(300) NOT NULL,
  `site` varchar(300) NOT NULL,
  `asn` varchar(300) NOT NULL,
  `num_packets` varchar(300) NOT NULL,
  `num_bytes` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8 ;

--
-- Dumping data for table `remote_user_detect_sybil_based_collusion_attacks`
--

INSERT INTO `remote_user_detect_sybil_based_collusion_attacks` (`id`, `source_ip`, `destination_ip`, `start_time`, `Network_Node_Text`, `source_port`, `destination_port`, `flags`, `site`, `asn`, `num_packets`, `num_bytes`, `Prediction`) VALUES
(2, '135.b1d10.d1c38.126', '135.0777d.04511.237', '1415754317', 'Two civilians are abducted and killed by the Mujahideen in separate incidents (Badran and Kulgam).\r\n', '22', '38662', '-AP---', '45c48', 'c4ca4', '6', '504', 'No Attack Found'),
(3, '135.0777d.04511.237', '135.b1d10.d1c38.37', '1415427333', 'An ambush on a security patrol leaves two members dead.', '48823', '22', '-A----,-AP---', '45c48', 'c4ca4', '12', '1008', 'Attack Found'),
(4, '135.0777d.04511.237', '135.b1d10.d1c38.151', '1415140946', 'Palestinian terrorist fires assault rifle into a bus-stop, killing two women and injuring forty others.\r\n', '33012', '22', '-A----,-AP---', '45c48', 'c4ca4', '12', '1008', 'Attack Found'),
(5, '135.0777d.04511.237', '135.b1d10.13fe9.61', '1415701785', 'Muslim separatists assassinate an independent newspaper editor in his office.\r\n', '45586', '22', '-A----,-AP---', '45c48', 'c4ca4', '12', '1008', 'No Attack Found'),
(6, '135.0777d.04511.237', '135.b1d10.d1c38.68', '1415667857', 'Two Muslim terrorists gun down a cop involved in anti-terror activities.\r\n', '33035', '22', '-A----,-AP---', '45c48', 'c4ca4', '12', '1008', 'No Attack Found'),
(7, '135.b1d10.b1d10.113', '135.0777d.04511.237', '1415749721', 'The bullet-riddled body of a fruit merchant is found two days after he was abducted.\r\n', '22', '51645', '-AP---', 'c9f0f', 'c4ca4', '5', '420', 'No Attack Found');
